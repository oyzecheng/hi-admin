<template>
  <div class="error-404">
    ...
    <p class="tips">该页面不存在！</p>
    <svg class="icon" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <path
        ...
        opacity="0.2"
      ></path>
      <image href="../../assets/images/character_6.png" height="300" x="205" y="30"></image>
      <path
        fill="#FFAB00"
    ...
    <a-button type="primary" @click="handleGoHome">去首页</a-button>
  </div>
</template>
